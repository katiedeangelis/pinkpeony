...
get_header(); ?>
	...
	<?php if ( isset( $jetpack_options['featured-image'] ) && '' != $jetpack_options['featured-image'] ) : ?>
		<div class="entry-thumbnail">
			<?php echo wp_get_attachment_image( (int)$jetpack_options['featured-image'], 'pinkpeony-page-thumbnail' ); ?>
		</div><!-- .thumbnail -->
	<?php endif; ?>

	<div class="content-wrapper <?php echo pinkpeony_additional_class(); ?>">
					...
					<header class="entry-header">
						<h1 class="entry-title">
							...
							if ( isset( $jetpack_options['page-title'] ) && '' != $jetpack_options['page-title'] )
								...
								esc_html_e( 'Testimonials', 'pinkpeony' );
							?>
						</h1>
					</header><!-- .entry-header -->
