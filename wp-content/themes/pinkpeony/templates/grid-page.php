...
get_header(); ?>
	...
	<div class="content-wrapper full-width <?php echo esc_attr( pinkpeony_additional_class() ); ?>">
		<div id="primary" class="content-area grid-page-content-area ">
			<div id="main" class="site-main" role="main">
				...
				<?php
					$pinkpeony_child_pages = new WP_Query( array(
						'post_type'      => 'page',
						'orderby'        => 'menu_order',
						'order'          => 'ASC',
						'post_parent'    => $post->ID,
				...
				<?php if ( $pinkpeony_child_pages->have_posts() ) : ?>

				<div class="child-pages grid">

						<?php
						while ( $pinkpeony_child_pages->have_posts() ) : $pinkpeony_child_pages->the_post();
