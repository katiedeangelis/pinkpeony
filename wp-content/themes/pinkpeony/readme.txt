...
With bold featured images and bright, cheerful colors, PinkPeony is ready to get to work for your business.
...
PinkPeony includes support for Jetpack's Infinite Scroll, Social Menus, Featured Content, and Testimonials.

== Setting Up Your Front Page ==

When you first activate PinkPeony, your homepage will display posts in a traditional blog format unlike the demo site at http://pinkpeonydemo.wordpress.com, which uses a static front page. If you would like to copy the look of the demo site, follow these steps:
...
On the theme demo (http://pinkpeonydemo.wordpress.com), this section is populated with three Featured Pages, each with a title, Featured Image, and excerpt. To re-create the same look, follow these directions:
...
PinkPeony includes one Custom Menu in the header, which can be configured via My Sites → Menus. If no menu is assigned, this area will display a list of your pages by default.

== Social Links Menu (requires Jetpack: jetpack.com) ==

With PinkPeony, you have the option to display links to your social media profiles in the header and footer. To display them, set up a Social Links Menu.

== Widget Areas ==

PinkPeony offers four widget areas:
...
Brand identity is very important — that’s why PinkPeony supports the Site Logo feature. To add your own image, go to Customize → Site Identity. The logo will appear in the header, above the site title.

== Testimonials (requires Jetpack: jetpack.me) ==

PinkPeony features testimonials in two ways:
...
= 6 December 2017 =
* Manually update pinkpeony es translation files
* Manually update pinkpeony.pot
